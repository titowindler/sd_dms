...
<body id="page-top">
  ...
  <div id="wrapper">
     ...
     while($rowFetch = mysqli_fetch_assoc($resultFetch)) {
        ...
        $deliver_date = $rowFetch['date_delivered'];

        $seller_name = $rowFetch['seller_name'];
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      <div class="card-header" style="color:black;border-bottom: white"><h3><center>VIEW DELIVERED PRODUCT</center></h3>
      <div class="card-body">
        <form class="form-horizontal" action="../../controller/edit_product.php"  method="post">
          ...
          <div class="form-group">
            <div class="form-label-group">
              <input type="text" class="form-control" value="<?php echo $deliver_date?>"  disabled >
           ...
           <div class="form-group">
            <div class="form-label-group">
              <input type="text"  class="form-control" value="<?php echo $seller_name?>"  disabled >
